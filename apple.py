...
class Apple:
    ...
    def __init__(self,coords):
        ...
        Class variables:
        self.location -- The logical coordinates of the apple's current position
        Arguments:
    ...
    def update(self,snake,n,m):
        ...
        The location is recreated until the apple appears outside of snake's body.
        Arguments:
    ...
    def draw(self,screen,scale):
        ...
        scale -- The scale parameter of the game, scales the locations to more pixels
        """
        loc = self.location
